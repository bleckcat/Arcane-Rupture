...
public class EndlessTerrain : MonoBehaviour
{
  ...
  const float srqViewerMoveThresholdForChunkUpdate =
  ...
  void Start()
  {
    ...
    maxViewDst = detailLevels[detailLevels.Length - 1].visibleDtsThreshold;
  ...
  public class TerrainChunk
  {
    ...
    public void UpdateTerrainChunk()
    {
      if (mapDataReceived)
      {
        ...
        bool visible = viewerDtsFromNearestEdge <= maxViewDst;
        ...
        if (visible)
        {
          ...
          {
            if (viewerDtsFromNearestEdge > detailLevels[i].visibleDtsThreshold)
            {
              lodIndex = i + 1;
            }
            else
